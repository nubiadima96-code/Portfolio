...
const heroStats = [
  ...
  { value: "AI & Product", label: "Focus" },
] as const;

const heroButtonClass =
  "inline-flex items-center gap-2 px-6 py-3 text-sm font-medium text-slate-100 bg-white/5 hover:bg-white/10 ring-1 ring-white/10 hover:ring-white/20 rounded-full transition";
      ...
      <div className="grid lg:grid-cols-12 gap-12 items-center">
        <AnimatedSection className="lg:col-span-7" delay={0.1}>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link href="/case-studies" className={heroButtonClass}>
              View Case Studies
              <ArrowRight className="w-4 h-4" aria-hidden />
            </Link>
            <a
